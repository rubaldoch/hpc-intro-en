...
```bash
`r config$remote$head_prompt` `r config$sched$hist`
```
...
```bash
`r config$remote$head_prompt` `r config$sched$hist` `r config$sched$flag$histdetail` 347087
```
...
```bash
`r config$remote$head_prompt` `r config$sched$hist` `r config$sched$flag$histdetail` 347087 | less -S
```
