...
1. `scp `r if (!is.null(config$remote$login_port) && nzchar(config$remote$login_port)) paste0("-p ", config$remote$login_port, " ") else ""` -r data `r config$remote$user`@`r config$remote$login_domain`:~/`
2. `rsync `r if (!is.null(config$remote$login_port) && nzchar(config$remote$login_port)) paste0("--port=", config$remote$login_port, " ") else ""` -ra data `r config$remote$user`@`r config$remote$login_domain`:~/`
3. `rsync `r if (!is.null(config$remote$login_port) && nzchar(config$remote$login_port)) paste0("--port=", config$remote$login_port, " ") else ""` -raz data `r config$remote$user`@`r config$remote$login_domain`:~/`
4. `tar -cvf data.tar data;`

   `rsync `r if (!is.null(config$remote$login_port) && nzchar(config$remote$login_port)) paste0("--port=", config$remote$login_port, " ") else ""` -raz data.tar `r config$remote$user`@`r config$remote$login_domain`:~/`
5. `tar -cvzf data.tar.gz data;`

   `rsync `r if (!is.null(config$remote$login_port) && nzchar(config$remote$login_port)) paste0("--port=", config$remote$login_port, " ") else ""` -ra data.tar.gz `r config$remote$user`@`r config$remote$login_domain`:~/`
